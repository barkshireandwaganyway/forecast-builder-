...
function mapShellHtml(data, p, mapClass, innerHtml, options={}){
  ...
  const status = (data.basemapImage || overlaySrc || customUrl) ? '' : `<div class="imageStatus fallback">Map image did not load. Editable fallback map layer shown.</div>`;
